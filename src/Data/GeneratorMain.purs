...
generatorMain =
  ...
  where
    go abiDir destDir p modulePrefix tr = void <<< launchAff $ generatePS {jsonDir : abiDir, pursDir : destDir, truffle: tr, exprPrefix: p, modulePrefix: modulePrefix, indentationLevel: 0}
