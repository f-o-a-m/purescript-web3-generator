...
type AdoptFn = Tagged (Proxy "adopt(uint256)") (Tuple1 (Tagged (Proxy "petId") (UIntN (D2 :& D5 :& DOne D6))))

adopt :: TransactionOptions NoPay -> { petId :: (UIntN (D2 :& D5 :& DOne D6)) } -> Web3 HexString
adopt x0 r = uncurryFields  r $ adopt' x0
   where
    adopt' :: TransactionOptions NoPay -> (Tagged (Proxy "petId") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
