...
type SetValuesFn = Tagged (Proxy "setValues(uint256,int256,bool,int224,bool[2],int256[],string,bytes16,bytes2[4][3][])") (Tuple9 (Tagged (Proxy "_uintVal") (UIntN (D2 :& D5 :& DOne D6))) (Tagged (Proxy "_intVal") (IntN (D2 :& D5 :& DOne D6))) (Tagged (Proxy "_boolVal") Boolean) (Tagged (Proxy "_int224Val") (IntN (D2 :& D2 :& DOne D4))) (Tagged (Proxy "_boolVectorVal") (Vector (DOne D2) Boolean)) (Tagged (Proxy "_intListVal") (Array (IntN (D2 :& D5 :& DOne D6)))) (Tagged (Proxy "_stringVal") String) (Tagged (Proxy "_bytes16Val") (BytesN (D1 :& DOne D6))) (Tagged (Proxy "_bytes2VectorListVal") (Array (Vector (DOne D4) (Vector (DOne D3) (BytesN (DOne D2)))))))
