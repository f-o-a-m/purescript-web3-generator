...
import Network.Ethereum.Web3.Solidity (BytesN, D1, D2, D3, D4, D5, D6, DOne, IntN, UIntN, Tuple0(..), Tuple1(..), Tuple2(..), Tuple9(..), class IndexedEvent, unTuple1)
...
type SetValuesFn = Tagged
  (Proxy "setValues(uint256,int256,bool,int224,bool[2],int256[],string,bytes16,bytes2[4][3][])")
