...
instance indexedEventTokenChange :: IndexedEvent (Tuple0 ) (Tuple2 (Tagged (Proxy "_old") Address) (Tagged (Proxy "_new") Address)) TokenChange where
  isAnonymous _ = false
...
instance indexedEventPreTransfer :: IndexedEvent (Tuple0 ) (Tuple3 (Tagged (Proxy "_from") Address) (Tagged (Proxy "_to") Address) (Tagged (Proxy "_value") (UIntN (D2 :& D5 :& DOne D6)))) PreTransfer where
  isAnonymous _ = false
