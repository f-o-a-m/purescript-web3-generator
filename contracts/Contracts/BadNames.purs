...
instance indexedEventEvT_BadEventName :: IndexedEvent (Tuple0 ) (Tuple1 (Tagged (Proxy "n") (UIntN (D2 :& D5 :& DOne D6)))) EvT_BadEventName where
  isAnonymous _ = false
...
type FnT_dumbFunctionFn = Tagged (Proxy "_dumbFunction(uint256)") (Tuple1 (Tagged (Proxy "n") (UIntN (D2 :& D5 :& DOne D6))))
...
_dumbFunction x0 r = uncurryFields  r $ _dumbFunction' x0
   where
    _dumbFunction' :: TransactionOptions NoPay -> (Tagged (Proxy "n") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
