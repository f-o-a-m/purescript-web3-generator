...
instance indexedEventStored :: IndexedEvent (Tuple0 ) (Tuple2 (Tagged (Proxy "x") (UIntN (D2 :& D5 :& DOne D6))) (Tagged (Proxy "y") (UIntN (D2 :& D5 :& DOne D6)))) Stored where
  isAnonymous _ = false
...
type SetTupleFn = Tagged (Proxy "setTuple(uint256,uint256)") (Tuple2 (Tagged (Proxy "x") (UIntN (D2 :& D5 :& DOne D6))) (Tagged (Proxy "y") (UIntN (D2 :& D5 :& DOne D6))))
...
setTuple x0 r = uncurryFields  r $ setTuple' x0
   where
    setTuple' :: TransactionOptions NoPay -> (Tagged (Proxy "x") (UIntN (D2 :& D5 :& DOne D6))) -> (Tagged (Proxy "y") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
