...
type ConstructorFn = Tagged (Proxy "constructor(uint256)") (Tuple1 (Tagged (Proxy "totalSupply") (UIntN (D2 :& D5 :& DOne D6))))
...
constructor x0 bc r = uncurryFields  r $ constructor' x0 bc
   where
    constructor' :: TransactionOptions NoPay -> HexString -> (Tagged (Proxy "totalSupply") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
...
instance indexedEventTransfer :: IndexedEvent (Tuple2 (Tagged (Proxy "_from") Address) (Tagged (Proxy "_to") Address)) (Tuple1 (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6)))) Transfer where
  isAnonymous _ = false
...
instance indexedEventApproval :: IndexedEvent (Tuple2 (Tagged (Proxy "_owner") Address) (Tagged (Proxy "_approved") Address)) (Tuple1 (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6)))) Approval where
  isAnonymous _ = false
...
instance indexedEventApprovalForAll :: IndexedEvent (Tuple2 (Tagged (Proxy "_owner") Address) (Tagged (Proxy "_operator") Address)) (Tuple1 (Tagged (Proxy "_approved") Boolean)) ApprovalForAll where
  isAnonymous _ = false
...
type ApproveFn = Tagged (Proxy "approve(address,uint256)") (Tuple2 (Tagged (Proxy "_to") Address) (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))))
...
approve x0 r = uncurryFields  r $ approve' x0
   where
    approve' :: TransactionOptions NoPay -> (Tagged (Proxy "_to") Address) -> (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
...
type ExistsFn = Tagged (Proxy "exists(uint256)") (Tuple1 (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))))
...
exists x0 cm r = uncurryFields  r $ exists' x0 cm
   where
    exists' :: TransactionOptions NoPay -> ChainCursor -> (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 (Either CallError Boolean)
...
type GetApprovedFn = Tagged (Proxy "getApproved(uint256)") (Tuple1 (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))))
...
getApproved x0 cm r = uncurryFields  r $ getApproved' x0 cm
   where
    getApproved' :: TransactionOptions NoPay -> ChainCursor -> (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 (Either CallError Address)
...
type IsApprovedForAllFn = Tagged (Proxy "isApprovedForAll(address,address)") (Tuple2 (Tagged (Proxy "_owner") Address) (Tagged (Proxy "_operator") Address))
...
isApprovedForAll x0 cm r = uncurryFields  r $ isApprovedForAll' x0 cm
   where
    isApprovedForAll' :: TransactionOptions NoPay -> ChainCursor -> (Tagged (Proxy "_owner") Address) -> (Tagged (Proxy "_operator") Address) -> Web3 (Either CallError Boolean)
...
type OwnerOfFn = Tagged (Proxy "ownerOf(uint256)") (Tuple1 (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))))
...
ownerOf x0 cm r = uncurryFields  r $ ownerOf' x0 cm
   where
    ownerOf' :: TransactionOptions NoPay -> ChainCursor -> (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 (Either CallError Address)
...
type SafeTransferFrom4Fn = Tagged (Proxy "safeTransferFrom4(address,address,uint256,bytes)") (Tuple4 (Tagged (Proxy "_from") Address) (Tagged (Proxy "_to") Address) (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) (Tagged (Proxy "_data") ByteString))
...
safeTransferFrom4 x0 r = uncurryFields  r $ safeTransferFrom4' x0
   where
    safeTransferFrom4' :: TransactionOptions NoPay -> (Tagged (Proxy "_from") Address) -> (Tagged (Proxy "_to") Address) -> (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) -> (Tagged (Proxy "_data") ByteString) -> Web3 HexString
...
type SafeTransferFrom3Fn = Tagged (Proxy "safeTransferFrom3(address,address,uint256)") (Tuple3 (Tagged (Proxy "_from") Address) (Tagged (Proxy "_to") Address) (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))))
...
safeTransferFrom3 x0 r = uncurryFields  r $ safeTransferFrom3' x0
   where
    safeTransferFrom3' :: TransactionOptions NoPay -> (Tagged (Proxy "_from") Address) -> (Tagged (Proxy "_to") Address) -> (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
...
type SetApprovalForAllFn = Tagged (Proxy "setApprovalForAll(address,bool)") (Tuple2 (Tagged (Proxy "_to") Address) (Tagged (Proxy "_approved") Boolean))
...
setApprovalForAll x0 r = uncurryFields  r $ setApprovalForAll' x0
   where
    setApprovalForAll' :: TransactionOptions NoPay -> (Tagged (Proxy "_to") Address) -> (Tagged (Proxy "_approved") Boolean) -> Web3 HexString
...
type TransferFromFn = Tagged (Proxy "transferFrom(address,address,uint256)") (Tuple3 (Tagged (Proxy "_from") Address) (Tagged (Proxy "_to") Address) (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))))
...
transferFrom x0 r = uncurryFields  r $ transferFrom' x0
   where
    transferFrom' :: TransactionOptions NoPay -> (Tagged (Proxy "_from") Address) -> (Tagged (Proxy "_to") Address) -> (Tagged (Proxy "_tokenId") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
